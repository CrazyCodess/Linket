...
(function($) {
	...
	function initHelper(jw) {
		if (!helper) {
			helper = $($.message.defaults.template).appendTo(jw==null?window.document.body:jw.document.body);
			$(jw==null?window:jw).bind("mousemove click keypress", fadeOutHelper);
		}
	}
