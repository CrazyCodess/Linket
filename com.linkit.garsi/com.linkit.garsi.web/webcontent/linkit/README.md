# AngularJS Ross Application

## Overview

This application takes the developer through the process of building a web-application using
angular. The application is loosely based on the **ross**, which no longer
exists. Here is a historical reference: [ross on WayBack]().
